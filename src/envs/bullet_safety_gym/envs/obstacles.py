...
class BlueBox(bases.Obstacle):
    def __init__(self, bc, init_xyz, fixed_base, movement, global_scaling=1.):
        super().__init__(
            bc=bc,
            name='blue_box',
            file_name='obstacles/blue-box.urdf',
            fixed_base=fixed_base,
            global_scaling=global_scaling,
            init_xyz=init_xyz,
            init_orientation=(0, 0, 2 * np.pi * random.uniform(0, 1)),
        ...
        self.symbols = set(self.name.lower().split('_'))
...
class BlueSphere(bases.Obstacle):
    def __init__(self, bc, init_xyz, fixed_base, movement, global_scaling=1.):
        super().__init__(
            bc=bc,
            name='blue_sphere',
            file_name='obstacles/blue-sphere.urdf',
            fixed_base=fixed_base,
            global_scaling=global_scaling,
            init_xyz=init_xyz,
            init_orientation=(0, 0, 2 * np.pi * random.uniform(0, 1)),
...
class PurpleBox(bases.Obstacle):
    def __init__(self, bc, init_xyz, fixed_base, movement, global_scaling=1.):
        super().__init__(
            bc=bc,
            name='purple_box',
            file_name='obstacles/purple-box.urdf',
            fixed_base=fixed_base,
            global_scaling=global_scaling,
            init_xyz=init_xyz,
            init_orientation=(0, 0, 2 * np.pi * random.uniform(0, 1)),
...
class PurpleSphere(bases.Obstacle):
    def __init__(self, bc, init_xyz, fixed_base, movement, global_scaling=1.):
        super().__init__(
            bc=bc,
            name='purple_sphere',
            file_name='obstacles/purple-sphere.urdf',
            fixed_base=fixed_base,
            global_scaling=global_scaling,
            init_xyz=init_xyz,
            init_orientation=(0, 0, 2 * np.pi * random.uniform(0, 1)),
...
class BeigeBox(bases.Obstacle):
    def __init__(self, bc, init_xyz, fixed_base, movement, global_scaling=1.):
        super().__init__(
            bc=bc,
            name='beige_box',
            file_name='obstacles/beige-box.urdf',
            fixed_base=fixed_base,
            global_scaling=global_scaling,
            init_xyz=init_xyz,
            init_orientation=(0, 0, 2 * np.pi * random.uniform(0, 1)),
...
class BeigeSphere(bases.Obstacle):
    def __init__(self, bc, init_xyz, fixed_base, movement, global_scaling=1.):
        super().__init__(
            bc=bc,
            name='beige_sphere',
            file_name='obstacles/beige-sphere.urdf',
            fixed_base=fixed_base,
            global_scaling=global_scaling,
            init_xyz=init_xyz,
            init_orientation=(0, 0, 2 * np.pi * random.uniform(0, 1)),
