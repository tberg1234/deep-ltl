...
register(
    ...
    kwargs=dict(
        ...
        task='NavTask',
        obstacles={
                   'BlueBox': {'number': 1, 'fixed_base': True,
                              'movement': 'static'},
                   'PurpleBox': {'number': 1, 'fixed_base': True,
                              'movement': 'static'},
                   'BeigeBox': {'number': 1, 'fixed_base': True,
                              'movement': 'static'},
                   'BlueSphere': {'number': 1, 'fixed_base': True,
                              'movement': 'static'},
                   'PurpleSphere': {'number': 1, 'fixed_base': True,
                              'movement': 'static'},
                   'BeigeSphere': {'number': 1, 'fixed_base': True,
                              'movement': 'static'},
                   },
        world={'name': 'SmallRoom', 'factor': 1},
        # debug=True
